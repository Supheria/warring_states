...
public partial class GameDisplayer : Displayer
{
    ...
    {
        LocalEvents.Hub.AddListener<GameFormUpdateCallback>(LocalEvents.Types.Hub.GameFormUpdate, args =>
        {
    ...
    {
        Relocate();
        LocalEvents.Hub.Broadcast(LocalEvents.Types.Hub.ImageUpdate, new GridToUpdateCallback(Image, GetGridRect(), BackColor, new(dX, dY)));
        DrawInfoBrand();
        Invalidate();
    }
